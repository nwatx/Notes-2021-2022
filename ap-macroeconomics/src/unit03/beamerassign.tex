...
\begin{document}
  ...
  \begin{frame}
	...
	\begin{itemize}
		\item The process through an economy will return to full employment without government intervention.
		...
		\item SRAS shocks correct in the long run; only increases in LRAS will lead to more long-term output.
	\end{itemize}
