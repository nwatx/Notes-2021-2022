...
\begin{document}
  ...
  \begin{frame}
	...
	\subsection{The wealth effect}
	\begin{itemize}
		\item Higher price levels reduce the purchasing power of money, which
		decreases the quantity of expenditures.
		\item Lower price levels increase purchasing power and increase
		expenditures
	\end{itemize}
