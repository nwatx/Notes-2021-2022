...
\begin{definition}[Supply Schedule]
...
\begin{definition}[The Law of Supply]
...
\begin{definition}[Market Equilibrium]
	...
	A shortage lies to the left of the supply and demand curves, where the
	demand is greater than the supply available.

	If we have a price above equilibrium, we end up with a surplus, where the
